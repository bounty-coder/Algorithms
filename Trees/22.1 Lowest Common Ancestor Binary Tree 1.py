...
# Method 1 finds LCA in O(n) time but requires three tree traversals plus extra spaces
# for path arrays. If we assume that the keys n1 and n2 are present in Binary Tree, 
