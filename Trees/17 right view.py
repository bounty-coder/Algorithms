...
# Approach
# traverse the tree anyhow using any traversal
# but we use preorder here as it will not take extra O(n) 
# space like level order.
# and save the element from that every level
class Solution:
